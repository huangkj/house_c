...
/**
 * Created by Mars on 2017/3/20 13:38.
 * 描述：Glide缓存处理
 */
...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(CacheManager.DIR_CACHE + CacheManager.DIR_NAME)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(CacheManager.DIR_CACHE + CacheManager.DIR_NAME, true);
    }

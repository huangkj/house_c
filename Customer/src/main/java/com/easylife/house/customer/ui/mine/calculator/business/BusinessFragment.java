...
public class BusinessFragment extends MVPBaseFragment<BusinessContract.View, BusinessPresenter> implements BusinessContract.View {
    ...
    public int getLayout() {
        return R.layout.calculator_fragment_business;
    }
    ...
    public void initViews() {
        ...
        rateBase = ((CalculatorActivity) getActivity()).rate2;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvDate:
                ...
                break;
            case R.id.tvRate:
                RateActivity.startActivity(BusinessFragment.this, rateBase, rateCurrent, true, 2);
                break;

...
/**
 * Created by Mars on 2017/5/4 09:47.
 * 捕获android程序崩溃日志<br>
...
//        LogOut.d(TAG, str);
        LogOut.d("ERROR:", getStackTraceString(ex));
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            LogOut.d("an error occured when collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogOut.d("an error occured when collect crash info", e);
            }
        }
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            LogOut.d("an error occured while writing file...", e);
        }
        return null;
    }

...
import com.easylife.house.customer.ui.houses.housedetailsimple.HousesDetailSimpleFragment;
import com.easylife.house.customer.ui.houses.housetype.housetypefragmentsimple.HousesTypeFragmentSimple;
 ...
 */
@RuntimePermissions
public class HousesAndTypeSimpleActivity extends MVPBaseActivity<HousesAndTypeSimpleContract.View, HousesAndTypeSimplePresenter> implements HousesAndTypeSimpleContract.View {
...
//    TextView tvLook;
    ...
    protected View setContentLayoutView() {
        return View.inflate(this, R.layout.activity_houses_and_type_simple_activity, null);
    }

    public static void startActivity(Activity activity, String devID, boolean isCollect, int requestCode) {
        activity.startActivityForResult(new Intent(activity, HousesAndTypeSimpleActivity.class)
    ...
    protected void initView() {
        ...
        HousesDetailSimpleFragment housesDetailFragment = HousesDetailSimpleFragment.newInstance();
        HousesTypeFragmentSimple housesTypeFragment = HousesTypeFragmentSimple.newInstance();
    ...
    @OnClick({R.id.rl_collect, R.id.tv_call, R.id.iv_back, R.id.iv_share, R.id.ivRecommend})
...
//                                .show();
    ...
    public void call(final String phone) {
        ...
        new AlertDialog.Builder(this).setTitle("提示")
                ...
                .setPositiveButton("呼叫", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        HousesAndTypeSimpleActivityPermissionsDispatcher.jumpCallPhoneWithCheck(HousesAndTypeSimpleActivity.this, phone);
                        dialog.dismiss();
                    }
                })
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        HousesAndTypeSimpleActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
    ...
    public void showDelCollectSucc() {
        CustomerUtils.showTip(HousesAndTypeSimpleActivity.this, "取消收藏");
    }

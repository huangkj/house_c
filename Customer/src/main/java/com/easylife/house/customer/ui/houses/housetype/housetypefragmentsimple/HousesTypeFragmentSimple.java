...
import com.easylife.house.customer.ui.houses.housetype.housesTypeDetailSimple.HousesTypeDetailSimpleActivity;
...
public class HousesTypeFragmentSimple extends MVPBaseFragment<HousesTypeContractSimple.View, HousesTypePresenterSimple> implements HousesTypeContractSimple.View {
    ...
    public static HousesTypeFragmentSimple newInstance() {
        HousesTypeFragmentSimple myFragment = new HousesTypeFragmentSimple();
        return myFragment;
    }
    ...
    public void initViews() {
        if(!TextUtils.isEmpty(((HousesAndTypeSimpleActivity)getActivity()).getDev_id())){
            mPresenter.requestHousesTypeList(((HousesAndTypeSimpleActivity)getActivity()).getDev_id());
        }
        mAdapter = new HousesTypeAdapter(R.layout.houses_type_list_item, allList);
        ...
        recycle.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter baseQuickAdapter, View view, int position) {
                ...
                startActivity(new Intent(getActivity(), HousesTypeDetailSimpleActivity.class).putExtra("HOUSE_TYPE_DETAIL",houseLayoutDataBean)
                        .putExtra("BASE_BEAN",((HousesAndTypeSimpleActivity)getActivity()).getBaseBean()));
            }
        });

        ((HousesAndTypeSimpleActivity)getActivity()).setNoNetTryRequestData(new HousesAndTypeSimpleActivity.NoNetTryRequestDataType() {
            @Override

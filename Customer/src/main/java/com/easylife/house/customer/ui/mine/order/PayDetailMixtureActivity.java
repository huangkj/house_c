...
public class PayDetailMixtureActivity extends BaseActivity implements RequestManagerImpl {
    public static void startActivity(Activity activity, String orderCode, int requestCode) {
        activity.startActivityForResult(new Intent(activity, PayDetailMixtureActivity.class).putExtra("orderCode", orderCode), requestCode);
    }

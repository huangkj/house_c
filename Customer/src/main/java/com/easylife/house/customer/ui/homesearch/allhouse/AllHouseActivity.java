...
public class AllHouseActivity extends MVPBaseActivity<AllHouseContract.View, AllHousePresenter> implements AllHouseContract.View, BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected View setContentLayoutView() {
        return View.inflate(this, R.layout.activity_all_house, null);
    }
    ...
    public static void startActivity(Activity activity, int type, String devName, String cityId, String city, String isTransparent, int requestCode) {
        activity.startActivityForResult(new Intent(activity, AllHouseActivity.class)
                        .putExtra("type", type)
...
//                    } else {
//                    startActivity(new Intent(AllHouseActivity.this, HousesAndTypeActivity.class).putExtra("DEV_ID", baseBean.devId).putExtra("coop", baseBean.coOp));
                    startActivity(new Intent(AllHouseActivity.this, HouseDetailActivity.class).putExtra("DEV_ID", baseBean.devId).putExtra("coop", baseBean.coOp));
//                }
                }
            }
        });
                    ...
                    areaPopWindow.setOnItemClickListener(new AreaPopWindow.OnItemClickListener() {
                        ...
                        public void onItemClick(CityAreaBean areaBean) {
                            ...
                            if (!areaBean.area.equals("全部")) {
                                ...
                                tvArea.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._ff6800));
                            } else {
                                tvArea.setText("全部");
                                tvArea.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._5d5d5d));
                            }
                ...
                if (pricePopWindow == null) {
                    ...
                    pricePopWindow.setOnConfirmClickListener(new ListPopWindow.OnConfirmClickListener() {
                        ...
                        public void onConfirmClick(String text) {
                            ...
                            if (!text.equals("不限")) {
                                ...
                                tvHousePrice.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._ff6800));
                            } else {
                                tvHousePrice.setText("房价");
                                tvHousePrice.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._5d5d5d));
                            }
                            onRefresh();
                        }
                    ...
                    pricePopWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
                        ...
                        public void onDismiss() {
                            ...
                            ivHousePrice.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(AllHouseActivity.this, R.color._c4c4c4)));
                            new Timer().schedule(new TimerTask() {
                                @Override
                                public void run() {
                                    KeyboardUtils.hideSoftInput(AllHouseActivity.this);
                                }
                            }, 200);
                        }
                    });
                ...
                if (houseAreaPopWindow == null) {
                    ...
                    houseAreaPopWindow.setOnConfirmClickListener(new ListPopWindow.OnConfirmClickListener() {
                        ...
                        public void onConfirmClick(String text) {
                            ...
                            if (!text.equals("不限")) {
                                ...
                                tvAcreage.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._ff6800));
                            } else {
                                tvAcreage.setText("面积");
                                tvAcreage.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._5d5d5d));
                            }
                            onRefresh();
                        }
                    ...
                    houseAreaPopWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
                        ...
                        public void onDismiss() {
                            ...
                            ivAcreage.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(AllHouseActivity.this, R.color._c4c4c4)));
                            new Timer().schedule(new TimerTask() {
                                @Override
                                public void run() {
                                    KeyboardUtils.hideSoftInput(AllHouseActivity.this);
                ...
                if (houseTypeFilterPopWindow == null) {
                    ...
                    houseTypeFilterPopWindow.setOnConfirmClickListener(new HouseTypeFilterPopWindow.OnConfirmClickListener() {
                        ...
                        public void onConfirmClick(Object[] pos1, Object[] pos2) {
                            ...
                            if (pos1.length > 0 || pos2.length > 0) {
                                tvMore.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._ff6800));
                            } else {
                                tvMore.setTextColor(ContextCompat.getColor(AllHouseActivity.this, R.color._5d5d5d));
                            }
                    ...
                    houseTypeFilterPopWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
                        ...
                        public void onDismiss() {
                            ...
                            ivMore.setImageTintList(ColorStateList.valueOf(ContextCompat.getColor(AllHouseActivity.this, R.color._c4c4c4)));
                        }
                    });
                }
        ...
        rcvHouseList.post(new Runnable() {
            ...
            public void run() {
                if (baseBeanList != null && baseBeanList.size() >= Constants.PAGE_SIZE) {
                    ...
                    CustomerUtils.showTip(AllHouseActivity.this, "没有更多数据了");
                }
            }
        });
    }

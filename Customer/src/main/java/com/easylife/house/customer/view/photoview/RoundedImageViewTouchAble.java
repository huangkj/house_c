 ...
 * 2015-4-13下午3:47:54
 */
public class RoundedImageViewTouchAble extends ImageView {
    ...
    public RoundedImageViewTouchAble(Context context) {
        super(context);
    }

    public RoundedImageViewTouchAble(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundedImageViewTouchAble(Context context, AttributeSet attrs, int defStyle) {
        ...
        cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView_corner, -1);

...
public class HousesDetailMainAdapter extends BaseQuickAdapter<HousesTypeBean.HouseLayoutDataBean, BaseViewHolder> {

    public HousesDetailMainAdapter(int layoutResId, List<HousesTypeBean.HouseLayoutDataBean> data) {
